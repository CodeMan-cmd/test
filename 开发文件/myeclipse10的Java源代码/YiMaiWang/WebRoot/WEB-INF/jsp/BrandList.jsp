...
<head>
    ...
    <script type="text/javascript" src="statics/js/milk_ban.js"></script>
    <script type="text/javascript" src="statics/js/paper_ban.js"></script>
    <script type="text/javascript" src="statics/js/baby_ban.js"></script>
...
<div class="top">
    ...
    <div class="search" >
    	<form method="post" action="selectLimit2" id="form1">
        	<input type="text" value="" class="s_ipt" name="name" value="${name}"/>
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <c:forEach items="${list}" var="p">
                	<li>
                    	<div class="img"><a href="#"><img src="statics/images/${p.fileName}" width="210" height="185" /></a></div>
                        <div class="price">
                ...
                <div class="pages">
                	<a href="javascript:void()" onclick="toTop()" class="p_pre">首页</a>
                	<a href="javascript:void()" onclick="toTop1()" class="p_pre">上一页</a>
                	<a href="#" class="cur">1</a><a href="#">2</a><a href="#">3</a>...<a href="#">20</a>
                	<a href="javascript:void()" onclick="toEnd()" class="p_pre">下一页</a>
                	<a href="javascript:void()" onclick="toEnd1()" class="p_pre">尾页</a>
...
<script type="text/javascript" src="statics/js/sets.js"></script>
</body>
<!--[if IE 6]>
