...
<html>
  ...
  <form  action="select" method="post">
		出版社类型：<select name="bookPublish"  >
				<option>请选择出版社</option>
				<option >机械出版社</option>
				<option >电子出版社</option>
			</select><span>${bug1}</span>
		作者：<input type="text" name="bookAuthor" value="${u.bookAuthor}">
		<input type="submit" value="查询">
	</form>
	<form id="form1" action="select">
  ...
  <table width="724" style="width: 100%; height: 100%;border: 1px solid;" >
  <tbody>
    <tr>
